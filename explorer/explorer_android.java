...
public class explorer_android {
    ...
    static public native void ImportCallback(InputStream f, long handler, String err);
    static public native void ExportCallback(OutputStream f, long handler, String err);
    ...
    public void openFile(View view, String mime, int id) {
        askPermission(view);
