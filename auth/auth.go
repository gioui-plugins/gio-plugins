...
//go:generate mkdir -p $TEMP/auth/classes
//go:generate javac -source 8 -target 8 -bootclasspath $ANDROID_HOME/platforms/android-30/android.jar -cp "./vendors/android/target/*" -d $TEMP/auth/classes auth_android.java
//go:generate jar cf auth_android.jar -C $TEMP/auth/classes .
